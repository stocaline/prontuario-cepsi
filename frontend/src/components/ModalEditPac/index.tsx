                    ...
                    <div className={styles.conteiner}>
                        <Tab.Group selectedIndex={bottomTabsIndex} onChange={setBottomTabsIndex}>
                            <Tab.List className={styles.bottomTabs}>
                                <Tab className={seletedTab1()}>Identificação</Tab>
                                <Tab className={seletedTab2()}>Endereço</Tab>
                                <Tab className={seletedTab3()}>Resposável</Tab>
                            </Tab.List>
                            <Tab.Panels>
                                <Tab.Panel>
                                ...
                                <Tab.Panel>
                                    {minor ?
                                        ...
                                        : <div className={styles.editFormContainer}>
                                            <p>Este paciente não é menor de idade</p>
                                        </div>
                                    }
                                </Tab.Panel>
                            </Tab.Panels>
